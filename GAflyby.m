function [rp_norm, rp, Dv_p, vp_p, vp_m] = GAflyby(V_min, V_plus, v_pl, mu_pl, R_pl, h_atm_pl, options)
% GAflyby Assisted flyby computation
% 
% Function to compute the assisted flyby around a planet
% 
% PROTOTYPE
%     [rp_norm, rp, Dv_p] = GAflyby(V_min, V_plus, v_pl, mu_pl, R_pl, h_atm_pl, options)
%     
% INPUT
...
%     Dv_p[1]           delta velocity given at perigee
%
% CONTRIBUTORS
%     Alberto Boffi, ...
% 
